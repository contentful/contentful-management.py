...
If you are an AI coding agent working in this repository, read `AGENTS.md <./AGENTS.md>`_ first.
It tells you where to find architectural context, development setup, decision records, and repo-specific rules.

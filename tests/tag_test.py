...
class TagTest(TestCase):
    ...
    @vcr.use_cassette('fixtures/tags/all.yaml')
    ...
    @vcr.use_cassette('fixtures/tags/create_public.yaml')
    ...
    @vcr.use_cassette('fixtures/tags/create_private.yaml')
    ...
    @vcr.use_cassette('fixtures/tags/find.yaml')
    ...
    @vcr.use_cassette('fixtures/tags/update.yaml')
    ...
    @vcr.use_cassette('fixtures/tags/delete.yaml')
    ...
    @vcr.use_cassette('fixtures/tags/add_tag_to_an_entry.yaml')
    ...
    @vcr.use_cassette('fixtures/tags/create_entry_with_tag.yaml')
    ...
    @vcr.use_cassette('fixtures/tags/add_tag_to_asset.yaml')
    ...
    @vcr.use_cassette('fixtures/tags/create_asset_with_tag.yaml')

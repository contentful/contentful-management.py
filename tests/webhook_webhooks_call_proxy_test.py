...
class WebhookWebhooksCallProxyTest(TestCase):
    def test_webhook_webhooks_call_proxy(self):
        ...
        self.assertEquals(str(proxy), "<WebhookWebhooksCallProxy space_id='orzkxlxlq59d' webhook_id='16ypL3XjNK6oreLPPoVBxI'>")
    ...
    def test_webhook_webhooks_call_proxy_find(self):
        ...
        self.assertEquals(str(webhook_call), "<WebhookCall[201] id='4KYbXQ9cg8CE2aqouWqY2i' url='https://circleci.com/api/v1/project/...' request_at='2017-06-21T22:44:42.624000+00:00' response_at='2017-06-21T22:44:43.086000+00:00'>")
